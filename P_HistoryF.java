...
// 구매 내역창 
public class P_HistoryF extends JFrame implements ActionListener, WindowListener {
	...
	public P_HistoryF(detail temp, Map<String, ImageIcon> map) 
	{
		...
		ButtonConfirm.setBounds(489, 681, 95, 71);
		...
		ButtonDeposit.setBounds(489, 600, 95, 71);
		...
		ButtonShip_s.setBounds(489, 520, 95, 71);
		...
		ButtonCancel_a.setBounds(489, 440, 95, 71);
		panel.add(ButtonCancel_a);
		
		ButtonReview = new JButton("\uB9AC\uBDF0 \uC791\uC131");
		ButtonReview.setBackground(Color.WHITE);
		ButtonReview.setFont(new Font("a뉴굴림3", Font.PLAIN, 12));
		ButtonReview.setBounds(489, 681, 85, 71);
		panel.add(ButtonReview);
		if(temp.getStatus() == 3)
		{
		...
		public void actionPerformed(ActionEvent e) {
			...
			// 리뷰 버튼
			else if(e.getSource() == ButtonReview)
			{
				if(MainF.reviewF == null)
				{
					new ReviewF(product, product1);
				}
			}
		}
